...
$IPTABLES -A $CHAIN -s 192.168.0.2 -d 192.168.1.2 -p udp --sport 10102 --dport 8080 -j ACCEPT
$IPTABLES -A $CHAIN -s 192.168.0.2 -d 192.168.1.2 -p udp --sport 10102 --dport 8081 -j ACCEPT
...
$IPTABLES -A $CHAIN -s 192.168.0.2 -d 192.168.1.3 -p udp --sport 10102 --dport 8080 -j ACCEPT
$IPTABLES -A $CHAIN -s 192.168.0.2 -d 192.168.1.3 -p udp --sport 10102 --dport 8081 -j ACCEPT
...
$IPTABLES -A $CHAIN -s 192.168.0.2 -d 192.168.1.4 -p udp --sport 10102 --dport 8080 -j ACCEPT
$IPTABLES -A $CHAIN -s 192.168.0.2 -d 192.168.1.4 -p udp --sport 10102 --dport 8081 -j ACCEPT
...
$IPTABLES -A $CHAIN -s 192.168.0.3 -d 192.168.1.2 -p udp --sport 10102 --dport 8080 -j ACCEPT
$IPTABLES -A $CHAIN -s 192.168.0.3 -d 192.168.1.2 -p udp --sport 10102 --dport 8081 -j ACCEPT
...
$IPTABLES -A $CHAIN -s 192.168.0.3 -d 192.168.1.3 -p udp --sport 10102 --dport 8080 -j ACCEPT
$IPTABLES -A $CHAIN -s 192.168.0.3 -d 192.168.1.3 -p udp --sport 10102 --dport 8081 -j ACCEPT
...
$IPTABLES -A $CHAIN -s 192.168.0.3 -d 192.168.1.4 -p udp --sport 10102 --dport 8080 -j ACCEPT
$IPTABLES -A $CHAIN -s 192.168.0.3 -d 192.168.1.4 -p udp --sport 10102 --dport 8081 -j ACCEPT
...
$IPTABLES -A $CHAIN -s 192.168.0.4 -d 192.168.1.2 -p udp --sport 10102 --dport 8080 -j ACCEPT
$IPTABLES -A $CHAIN -s 192.168.0.4 -d 192.168.1.2 -p udp --sport 10102 --dport 8081 -j ACCEPT
...
$IPTABLES -A $CHAIN -s 192.168.0.4 -d 192.168.1.3 -p udp --sport 10102 --dport 8080 -j ACCEPT
$IPTABLES -A $CHAIN -s 192.168.0.4 -d 192.168.1.3 -p udp --sport 10102 --dport 8081 -j ACCEPT
...
$IPTABLES -A $CHAIN -s 192.168.0.4 -d 192.168.1.4 -p udp --sport 10102 --dport 8080 -j ACCEPT
$IPTABLES -A $CHAIN -s 192.168.0.4 -d 192.168.1.4 -p udp --sport 10102 --dport 8081 -j ACCEPT
